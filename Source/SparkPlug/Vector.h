...
// 		vec( const Component& X ) { TVEC_FOR(i) set(i,X); }
		...
		Component get( int i ) const { TVEC_RANGE_TEST(i); return ((const Component*)this)[i]; }

		Component& operator[] ( const int& i ) { TVEC_RANGE_TEST(i); return ((Component*)this)[i]; }
		const Component& operator[] ( const int& i ) const { TVEC_RANGE_TEST(i); return ((const Component*)this)[i]; }
